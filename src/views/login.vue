<template>
  <div class="page-login">
    <div class="login-box">
      ...
      <p class="text-tips">Hi, Welcome here !</p>
      <form action="#" class="login-form">
        ...
        <button class="submit" @click.prevent="handleLogin" v-loading="isLoging">Login</button>
      </form>
...
<style scoped>
  ...
  .login-box .password {
    ...
    line-height: 25px;
    box-shadow: 1px 1px 3px rgb(0,0,0,0.02);
    border-radius: 3px;
    transition: all 300ms ease;
  }
  .login-box .username:focus,
  .login-box .password:focus {
  ...
  .login-box .submit.submit-text:hover {
